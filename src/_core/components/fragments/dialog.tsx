...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay className="w-full fixed inset-0 flex items-center justify-center overflow-y-auto backdrop-blur">
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "relative max-w-[80vw] dark:bg-background z-50 grid w-full rounded-lg gap-4 border bg-background p-6 shadow-lg",
          "data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out",
